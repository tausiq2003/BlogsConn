...
<?php
    ...
    $sql_posts = "SELECT * FROM blogsdata";
    $query_posts = mysqli_query($connection, $sql_posts);

    $sql_contacts = "SELECT * FROM userdetails";
    ...
    $sql_comments = "SELECT *
    FROM comments
    INNER JOIN blogsdata ON comments.bid = blogsdata.id
    INNER JOIN userdetails ON blogsdata.user_id = userdetails.user_id";
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
                <div class="top-left-part"><a class="logo" href="index.php"><b><img src="../plugins/images/icon.png" style="width: 30px; height: 30px;" alt="home" /></b><span class="hidden-xs"><b>BlogsConn</b></span></a></div>
            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                    ...
                    <li><a href="user.php" class="waves-effect"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Users</span></a>
                    </li>
        ...
        <div id="page-wrapper">
                                ...
                                <div class="col-lg-3 col-sm-6 row-in-br">
                                    <div class="col-in row">
                                        <div class="col-md-6 col-sm-6 col-xs-6"> <i data-icon="E" class="linea-icon linea-basic"></i>
                                            <h5 class="text-muted vb">Blogs</h5> </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center">
                                <div class="comment-body">
                                    ...
                                    $blogid = $row2["id"];
                                       //write sql join statement, join userstable and blogstable
                                       $sql2 = "SELECT *
                                       FROM comments
                                       INNER JOIN blogsdata ON comments.bid = blogsdata.id
                                       INNER JOIN userdetails ON blogsdata.user_id = userdetails.user_id
                                       WHERE comments.bid = '$blogid'";
                                    ...
                                    echo '                
                                        ...
                                        '.$row3["comment"].'
                                        </span> <span class="time pull-right">'.$row3["created_on"].'</span>
                                    ';
                                    $counter++;
                                        } } }
                                    ?>
                                ...
                                <table class="table ">
                                    ...
                                    <?php
                                             if (mysqli_num_rows($query_posts)==0) {
                                                 echo "<i style='color:brown;'>No Posts Yet :( Upload BlogsConn's first blog post today! </i> ";
                                                    }
                                                    else
                                                ...
                                                {
                                                    $postid = $row["id"];
                                                    $sql2 = "SELECT * FROM blogsdata WHERE id=$postid";
                                                    $query2 = mysqli_query($connection, $sql2);

                                                    echo '
                                                    <tr>
                                                        <td class="txt-oflo">'.$row["title"].'</td>
                                                        <td class="txt-oflo">'.$row["created_on"].'</td>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2023 &copy; BlogsConn Admin </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
    ...
    $(document).ready(function() {
        $.toast({
            heading: 'Welcome to BlogsConn admin',
