                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mail_listing">
                                    ...
                                    if (isset($_GET["deleted"])) {
                                        ...
                                        '<div class="alert alert-warning" >
                                             ...
                                             <strong>Blocked!! </strong><p> The comment has been successfully blocked.</p>
                                        </div>'
                                        ;
                                    }
                                    elseif (isset($_GET["del_error"])) {
                                        ...
                                        '<div class="alert alert-danger" >
                                              <a href="#" class="close" data-dismiss="alert" aria-label="close"></a>
                                             <strong>ERROR!! </strong><p> There was an error during blocking this record. Please try again.</p>
                                        </div>'
                                        ;
                                    }
                                ?>  
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    while ($row2 = mysqli_fetch_assoc($query2)) {
                                                        ...
                                                        <div class="mail-contnet">
                                                            <b>'.$row["name"].'</b>
                                                            <h5>Blog Title : '.$row["title"].'</h5>
                                                            <span class="mail-desc">
                                                            '.$row["comment"].'
                                                            </span><a href="javacript:void(0)" class="action" data-toggle="modal" data-target="#responsive-modal'.$row["id"].'"><i class="ti-close text-danger"></i></a></span>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            ...
                                                                            <h4 class="modal-title">Are you sure you want to block this comment?</h4>
                                                                        </div>
