            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                    ...
                    <li><a href="user.php" class="waves-effect active"><i data-icon="n" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Users</span></a>
                    </li>
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0">BlogsConn Users</h3>
                                    ...
                                    if (mysqli_num_rows($query)==0) {
                                                ...
                                                while ($row = mysqli_fetch_array($query)) {
                                                    ...
                                                    if ($row["status"] == 0) {
                                                        ...
                                                        echo '<form method="post" action="functions/del_user.php">
