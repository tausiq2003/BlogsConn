...
<body style="background-color: #ece9e9; margin-top: 100px;">
  <!-- Navbar -->
  ...
  <?php if (isset($_REQUEST['info'])) { ?>
    ...
    <?php if ($_REQUEST['info'] == 'present') { ?>
      <div class="alert error-dailog" id="alert">
        User already exists!
        <svg id="close-btn" onclick=closeFunction() xmlns="http://www.w3.org/2000/svg" width="24" height="24"
          viewBox="0 0 24 24">
          <path
...
<div style="margin-bottom: 100px !important;">
  <form class="login-form" method="POST" autocomplete="off">
    ...
    <input name='user-id' type="text" value="<?php echo $_GET['id']; ?>" hidden />
